...
OPTIONS = {
    ...
    'plist': {
        'CFBundleName': 'Dcon Mix',
        'CFBundleDisplayName': 'Dcon Mix',
        'CFBundleIdentifier': 'com.dconmix.midimixer',
...
setup(
    name='Dcon Mix',
    version='1.0.1',
    description='Dcon Mix - MIDI mixer control application for DM3 and Qu-5/6/7 mixers',
    author='MControl',
    author_email='',
    url='',
    app=APP,
